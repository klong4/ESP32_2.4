...
// Create    : JAVEN LIU
// Date      : 2022-02-15
// Drive IC  : LCD:ILI9341  TP:FT6236U  FLASH: W25Q32BV   FONT CHIP:GT21L16T1W
// INTERFACE : LCD 16BIT 8080   TP:I2C  FLASH:SPI   FONT CHIP:SPI  SD CARD: SPI
// MCU 		 : STC12LE5C60S2
// VDD		 : 5V OR 3.3 V
// MCU VDD   : 3.3V
//----------------------------------------------------------------------
